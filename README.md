...
2. ~~2019/08/25 : 과제 리뷰, 설명 (jquery 실습 > 이벤트), 웹 UI 만들기 실습 > tab 콘텐츠, > 과제 (PC실습 도미노피자 마무리)
    - 이벤트 : 클릭, resize, scroll, load ...~~
3. 과제 리뷰, 웹 UI 만들기 실습 > 아코디언(FAQ), 레이어팝업, GNB > 과제 (PC실습 도미노피자)
4. 과제 리뷰, 웹 UI 만들기 실습 > 스크롤 위치에 따른 header 걸치기 UI
